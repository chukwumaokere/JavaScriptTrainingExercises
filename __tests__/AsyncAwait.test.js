...
describe('should pass all tests', () => {
    ...
    it ('should get the first user and print it on the terminal', async () => {
    ...
    it('should call fetchUser and return the expected user', async () => {
    ...
    it ('should return the top 5 users and print it on the terminal', async () => {
      fetchSpy.mockResolvedValue({
